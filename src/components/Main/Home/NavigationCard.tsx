    ...
    <div className="flex flex-col w-108 lg:w-96 p-8 lg:px-12 mt-0 max-w-3xl bg-white border border-gray-300 rounded-lg shadow-lg mx-auto">
        <div className="flex flex-col">
          ...
          <div className="mt-2 mb-4">
            <LargeButton caption="アカウント登録" btnClass="btn btn-inactive-indigo rounded-lg" onClick={toSignUpPage} />
          </div>
        </div>
        <div className="flex flex-col">
          <p className="text-center text-sm font-bold text-gray-800">アカウントをお持ちの方</p>
          <div className="mt-2 mb-2">
            <LargeButton caption="ログイン" btnClass="btn btn-active-indigo rounded-lg" onClick={toSignInPage} />
          </div>
        </div>
      {/* <!-- ボーダー（始まり） --> */}
      ...
      {/* <!-- ボーダー（終わり） --> */}
        <div className="flex flex-col mt-6">
          ...
          <div className="mt-2">
            <LargeButton caption="ゲストログイン（閲覧用）" btnClass="btn btn-inactive-gray rounded-lg" onClick={() => console.log('ゲストログイン（閲覧用）ボタンを押下しました。')} />
          </div>
        </div>
    </div>
  )
